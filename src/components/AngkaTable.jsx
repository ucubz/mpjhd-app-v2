...
export default function AngkaTable({ state }) { if (!state) return null;

return ( <div className="overflow-x-auto rounded-lg border"> <table className="w-full text-sm text-left border-collapse"> <thead> <tr className="bg-gray-200 dark:bg-gray-800"> <th className="p-2 border font-bold text-center text-gray-700 dark:text-gray-200 w-1/12">No</th> <th className="p-2 border font-bold text-center text-gray-700 dark:text-gray-200">Unsur Unsur</th> <th className="p-2 border font-bold text-center text-gray-700 dark:text-gray-200 w-1/6">Jumlah</th> </tr> </thead> <tbody>
