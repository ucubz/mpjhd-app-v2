      ...
      <Card> // 
        ...
        {showPeran && ( // 
          <div className="mb-6"> // 
            ...
            <RadioGroup value={faktor.peran} onChange={(val) => updateFaktor('peran', val)}> // 
              <div className="space-y-2"> // 
        ...
        {showKerugian && ( // 
          <div className="mb-6"> // 
            <p className="font-semibold mb-2">Jumlah uang yang diterima atau kerugian:</p> // 
            <RadioGroup value={faktor.jumlahKerugian} onChange={(val) => updateFaktor('jumlahKerugian', val)}> // 
              <div className="space-y-2"> // 
